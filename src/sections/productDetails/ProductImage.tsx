...
const ProductImage: React.FC<ProductImageProps> = ({ product }) => {
  ...
  return (
    <div className="flex flex-col items-center lg:ml-10 w-full md:w-[100%] ">
      {/* Main Slider Image */}
      <div className="relative w-[90vw] sm:w-[400px] max-w-xl   rounded-lg shadow-lg overflow-hidden">
        <img
